	...
	public class DefaultSocket
	{
		...
		private static IMessage? GetEnvelopePayload(Rt.Envelope envelope)
		{
			return envelope.MessageCase switch
			{
				...
				Rt.Envelope.MessageOneofCase.ChannelPresenceEvent => envelope.ChannelPresenceEvent,
				...
				Rt.Envelope.MessageOneofCase.VoiceStartedEvent => envelope.VoiceStartedEvent,
				Rt.Envelope.MessageOneofCase.VoiceEndedEvent => envelope.VoiceEndedEvent,
				Rt.Envelope.MessageOneofCase.ChannelCreatedEvent => envelope.ChannelCreatedEvent,
				Rt.Envelope.MessageOneofCase.ChannelDeletedEvent => envelope.ChannelDeletedEvent,
				Rt.Envelope.MessageOneofCase.ChannelUpdatedEvent => envelope.ChannelUpdatedEvent,
				Rt.Envelope.MessageOneofCase.CheckNameExistedEvent => envelope.CheckNameExistedEvent,
				Rt.Envelope.MessageOneofCase.UserChannelAddedEvent => envelope.UserChannelAddedEvent,
				Rt.Envelope.MessageOneofCase.UserChannelRemovedEvent => envelope.UserChannelRemovedEvent,
				Rt.Envelope.MessageOneofCase.UserClanRemovedEvent => envelope.UserClanRemovedEvent,
				Rt.Envelope.MessageOneofCase.ClanUpdatedEvent => envelope.ClanUpdatedEvent,
				Rt.Envelope.MessageOneofCase.ClanProfileUpdatedEvent => envelope.ClanProfileUpdatedEvent,
				Rt.Envelope.MessageOneofCase.UserProfileUpdatedEvent => envelope.UserProfileUpdatedEvent,
				Rt.Envelope.MessageOneofCase.AddClanUserEvent => envelope.AddClanUserEvent,
				Rt.Envelope.MessageOneofCase.ClanEventCreated => envelope.ClanEventCreated,
				Rt.Envelope.MessageOneofCase.RoleAssignEvent => envelope.RoleAssignEvent,
				Rt.Envelope.MessageOneofCase.ClanDeletedEvent => envelope.ClanDeletedEvent,
				Rt.Envelope.MessageOneofCase.GiveCoffeeEvent => envelope.GiveCoffeeEvent,
				Rt.Envelope.MessageOneofCase.StickerCreateEvent => envelope.StickerCreateEvent,
				Rt.Envelope.MessageOneofCase.StickerUpdateEvent => envelope.StickerUpdateEvent,
				Rt.Envelope.MessageOneofCase.StickerDeleteEvent => envelope.StickerDeleteEvent,
				Rt.Envelope.MessageOneofCase.RoleEvent => envelope.RoleEvent,
				Rt.Envelope.MessageOneofCase.EventEmoji => envelope.EventEmoji,
				Rt.Envelope.MessageOneofCase.StreamingJoinedEvent => envelope.StreamingJoinedEvent,
				Rt.Envelope.MessageOneofCase.StreamingLeavedEvent => envelope.StreamingLeavedEvent,
				Rt.Envelope.MessageOneofCase.StreamingStartedEvent => envelope.StreamingStartedEvent,
				Rt.Envelope.MessageOneofCase.StreamingEndedEvent => envelope.StreamingEndedEvent,
				Rt.Envelope.MessageOneofCase.PermissionSetEvent => envelope.PermissionSetEvent,
				Rt.Envelope.MessageOneofCase.PermissionChangedEvent => envelope.PermissionChangedEvent,
				Rt.Envelope.MessageOneofCase.TokenSentEvent => envelope.TokenSentEvent,
				Rt.Envelope.MessageOneofCase.UnmuteEvent => envelope.UnmuteEvent,
				Rt.Envelope.MessageOneofCase.WebrtcSignalingFwd => envelope.WebrtcSignalingFwd,
				Rt.Envelope.MessageOneofCase.ListActivity => envelope.ListActivity,
				Rt.Envelope.MessageOneofCase.DropdownBoxSelected => envelope.DropdownBoxSelected,
				Rt.Envelope.MessageOneofCase.IncomingCallPush => envelope.IncomingCallPush,
				Rt.Envelope.MessageOneofCase.SdTopicEvent => envelope.SdTopicEvent,
				Rt.Envelope.MessageOneofCase.FollowEvent => envelope.FollowEvent,
				Rt.Envelope.MessageOneofCase.ChannelAppEvent => envelope.ChannelAppEvent,
				Rt.Envelope.MessageOneofCase.UserStatusEvent => envelope.UserStatusEvent,
				Rt.Envelope.MessageOneofCase.RemoveFriend => envelope.RemoveFriend,
				Rt.Envelope.MessageOneofCase.WebhookEvent => envelope.WebhookEvent,
				Rt.Envelope.MessageOneofCase.NotiUserChannel => envelope.NotiUserChannel,
				Rt.Envelope.MessageOneofCase.JoinChannelAppData => envelope.JoinChannelAppData,
				Rt.Envelope.MessageOneofCase.CanvasEvent => envelope.CanvasEvent,
				Rt.Envelope.MessageOneofCase.UnpinMessageEvent => envelope.UnpinMessageEvent,
				Rt.Envelope.MessageOneofCase.CategoryEvent => envelope.CategoryEvent,
				Rt.Envelope.MessageOneofCase.HandleParticipantMeetStateEvent => envelope.HandleParticipantMeetStateEvent,
				Rt.Envelope.MessageOneofCase.DeleteAccountEvent => envelope.DeleteAccountEvent,
				Rt.Envelope.MessageOneofCase.EphemeralMessageSend => envelope.EphemeralMessageSend,
				Rt.Envelope.MessageOneofCase.BlockFriend => envelope.BlockFriend,
				Rt.Envelope.MessageOneofCase.VoiceReactionSend => envelope.VoiceReactionSend,
				Rt.Envelope.MessageOneofCase.MarkAsRead => envelope.MarkAsRead,
				Rt.Envelope.MessageOneofCase.ListDataSocket => envelope.ListDataSocket,
				Rt.Envelope.MessageOneofCase.QuickMenuEvent => envelope.QuickMenuEvent,
				Rt.Envelope.MessageOneofCase.UnBlockFriend => envelope.UnBlockFriend,
				Rt.Envelope.MessageOneofCase.MeetParticipantEvent => envelope.MeetParticipantEvent,
				Rt.Envelope.MessageOneofCase.TransferOwnershipEvent => envelope.TransferOwnershipEvent,
				Rt.Envelope.MessageOneofCase.AddFriend => envelope.AddFriend,
				Rt.Envelope.MessageOneofCase.BanUserEvent => envelope.BanUserEvent,
				Rt.Envelope.MessageOneofCase.ActiveArchivedThread => envelope.ActiveArchivedThread,
				Rt.Envelope.MessageOneofCase.AllowAnonymousEvent => envelope.AllowAnonymousEvent,
				Rt.Envelope.MessageOneofCase.ApiRequestEvent => envelope.ApiRequestEvent,
				Rt.Envelope.MessageOneofCase.ClanCreatedEvent => envelope.ClanCreatedEvent,
				Rt.Envelope.MessageOneofCase.AiagentEnabledEvent => envelope.AiagentEnabledEvent,
				Rt.Envelope.MessageOneofCase.ListChannelUsersBannedEvent => envelope.ListChannelUsersBannedEvent,
				Rt.Envelope.MessageOneofCase.RefreshSessionEvent => envelope.RefreshSessionEvent,
				Rt.Envelope.MessageOneofCase.ChannelArchiveEvent => envelope.ChannelArchiveEvent,
				Rt.Envelope.MessageOneofCase.TopicInMessageEvent => envelope.TopicInMessageEvent,
				Rt.Envelope.MessageOneofCase.ScreenShareEvent => envelope.ScreenShareEvent,
				_ => null,
			};
		}
